...
export default defineEventHandler(async (event: any) => {
  ...
  register.run({ id: newId, email: body.email, password: body.password, data: '{"name":"","avatar":"profile-mr-dark.png","contact":[],"status":"","skills":[],"hobbies":[],"bio":"","projects":[],"questions":[]}'})
